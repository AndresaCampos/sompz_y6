...
# def join_cell_assig_files(path_cats, som_type, shear):
#     cells = []
...
def join_cell_assig_files_unsheared(path_cats, som_type):
    cells = []
    for item in range(128):
        for subsample in range(10):
            cells_subsample = np.load(f'{path_cats}/{som_type}_unsheared/som_wide_32x32_1e7_assign_{item}_subsample_{subsample}.npz')['cells']
            cells.append(cells_subsample)
...
join_cell_assig_files(path_cats, som_type, 'sheared_1m')
join_cell_assig_files(path_cats, som_type, 'sheared_1p')
join_cell_assig_files(path_cats, som_type, 'sheared_2m')
join_cell_assig_files(path_cats, som_type, 'sheared_2p')
join_cell_assig_files_unsheared(path_cats, som_type)
