...
path_cats = '/global/cscratch1/sd/acampos/SOM/cats_sompz'
#'your/favorite/path/here/'
...
# deep_file = '/global/cscratch1/sd/acampos/SOM/deep_balrog_mocked.pkl'
...
np.save("%s/som_deep_64_64.npy" % path_cats, som.weights)
