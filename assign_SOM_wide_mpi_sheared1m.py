...
path_out = '/global/cscratch1/sd/acampos/sompz/test/full_run_on_data/SOM/cats_Y3'
...
def assign_som(index):
    ...
    filename = f'{path_out}/{som_type}_{shear}/som_wide_32x32_1e7_assign_{som_type}_{shear}_{rank}_subsample_{index}.npz'
